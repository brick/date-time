...
class LocalDateTimeTest extends AbstractTestCase
{
    ...
    public static function providerParseInvalidDateTimeThrowsException(): array
    {
        return [
            ['2014-00-15T12:34'],
            ['2014-13-15T12:34'],
    ...
    {
        self::assertSame($month, LocalDateTime::of(2000, $monthValue, 1)->getMonth());
    }
    ...
    public static function providerGetDayOfYear(): array
    {
        return [
            [2000, 1, 1, 1],
            [2000, 3, 1, 61],
    ...
    public static function providerWithDate(): array
    {
        return [
            [2001, 2, 3],
            [2002, 3, 1],
    ...
    public static function providerWithTime(): array
    {
        return [
            [4, 5, 6, 789],
            [5, 6, 4, 987],
    ...
    public static function providerMinusNanos(): array
    {
        return [
            ['2000-03-01T00:00', 0, '2000-03-01T00:00'],
    ...
    public static function providerAtTimeZone(): array
    {
        return [
            ['2001-03-28T23:23:23', '-06:00', 985843403, 0],
            ['2001-03-28T23:23:23', '-06', 985843403, 0],
            ['1960-04-30T06:00:00.123456', '+02:00', -305236800, 123456000],
            ['1960-04-30T06:00:00.123456', '+02', -305236800, 123456000],
    ...
    public static function providerForPastFuture(): array
    {
        return [
            ...
            [1234567890, '2009-02-14T00:31:29', '+01', false],
            [1234567890, '2009-02-14T00:31:31', '+01:00', true],
            [1234567890, '2009-02-14T00:31:31', '+01', true],
            [2345678901, '2044-04-30T17:28:20', '-08:00', false],
            [2345678901, '2044-04-30T17:28:20', '-08', false],
            [2345678901, '2044-04-30T17:28:22', '-08:00', true],
            [2345678901, '2044-04-30T17:28:22', '-08', true],
        ];
    }
    ...
    {
        self::assertSame(json_encode($expected, JSON_THROW_ON_ERROR), json_encode(LocalDateTime::of($year, $month, $day, $hour, $minute, $second, $nano), JSON_THROW_ON_ERROR));
    }
